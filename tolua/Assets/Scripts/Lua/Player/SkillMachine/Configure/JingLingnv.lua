...
Role_Configure_JingLingnv = {
    ...
    StateList = {
        ---------------------------待机开始--------------------------------
        {
            ...
            PluginList = {
                { name = "PlayerSkillAnimationPlugin", class = PlayerSkillAnimationPlugin,  animationClip ="free",loop = true },
            }
        },
        ---------------------------待机结束--------------------------------
        ---------------------------移动开始--------------------------------
        {
            ...
            PluginList = {
                { name = "PlayerSkillAnimationPlugin", class = PlayerSkillAnimationPlugin,  animationClip ="walk",loop = true },
        ...
        ---------------------------死亡开始--------------------------------
        {
            ...
            PluginList = {
                { name = "PlayerSkillAnimationPlugin", class = PlayerSkillAnimationPlugin,  animationClip ="death",loop = false },
        ...
        ---------------------------普攻一段开始--------------------------------
        {
            ...
            weight = 1,
            ChangeList = {
                {enum = "Idle",endAt= 1.4, beginAt= 0, speed = 1, fadeLength = 0.3 },
                {enum = "Run",endAt=0.26, beginAt= 0, speed = 5, fadeLength = 0.2 },                
            ...
            PluginList = {
                { name = "PlayerSkillAnimationPlugin", class = PlayerSkillAnimationPlugin,  animationClip ="attack",loop = false },
        ...
        ---------------------------普攻二段开始--------------------------------
        {
            ...
            weight = 1,
            ChangeList = {
                {enum = "Idle",endAt= 1.40, beginAt= 0, speed = 1, fadeLength = 0 },
                {enum = "Run",endAt=0.26, beginAt= 0, speed = 5, fadeLength = 0.2 },                
            ...
            PluginList = {
                { name = "PlayerSkillAnimationPlugin", class = PlayerSkillAnimationPlugin,  animationClip ="attack2",loop = false },
                { name = "PlayerSkillAttackSpeedPlugin", class = PlayerSkillAttackSpeedPlugin },
                { name = "PlayerSkillRotationPlugin", class = PlayerSkillRotationPlugin, duration = 0.2, immediately = false },                 
                { name = "PlayerSkillEffectPlugin", class = PlayerSkillEffectPlugin, beginAt = 0.25,
                    EffectPluginList = {
        ...
        ---------------------------普攻三段开始--------------------------------
        {
            ...
            PluginList = {
                { name = "PlayerSkillAnimationPlugin", class = PlayerSkillAnimationPlugin,  animationClip ="attack3",loop = false },
                { name = "PlayerSkillAttackSpeedPlugin", class = PlayerSkillAttackSpeedPlugin },
                { name = "PlayerSkillRotationPlugin", class = PlayerSkillRotationPlugin, duration = 0.2, immediately = false },                 
                { name = "PlayerSkillEffectPlugin", class = PlayerSkillEffectPlugin, beginAt = 0.25,
                    EffectPluginList = {
        ...
        ---------------------------技能一开始--------------------------------
        {
            ...
            weight = 1,
            ChangeList = {
                {enum = "Idle",endAt= 0.80, beginAt= 0, speed = 1, fadeLength = 0 },
                {enum = "Run",endAt=0.26, beginAt= 0, speed = 5, fadeLength = 0.2 },                
            ...
            PluginList = {
                { name = "PlayerSkillAnimationPlugin", class = PlayerSkillAnimationPlugin,  animationClip ="skill",loop = false },
                { name = "PlayerSkillAttackSpeedPlugin", class = PlayerSkillAttackSpeedPlugin },    
                { name = "PlayerSkillRotationPlugin", class = PlayerSkillRotationPlugin, duration = 0.2, immediately = false },                          
        ...
        ---------------------------技能二开始--------------------------------
        {
            ...
            weight = 1,
            ChangeList = {
                {enum = "Idle",endAt= 1.20, beginAt= 0, speed = 1, fadeLength = 0 },
                {enum = "Run",endAt=1.20, beginAt= 0, speed = 1, fadeLength = 0.2 },                
            ...
            PluginList = {
                { name = "PlayerSkillAnimationPlugin", class = PlayerSkillAnimationPlugin,  animationClip ="skill2",loop = false },
                { name = "PlayerSkillAttackSpeedPlugin", class = PlayerSkillAttackSpeedPlugin }, 
            }
        },
        ---------------------------技能二结束-------------------------------- 
        ---------------------------技能三开始--------------------------------
        {
            ...
            ChangeList = {
                {enum = "Idle",endAt= 0.80, beginAt= 0, speed = 1, fadeLength = 0 },
                {enum = "Run",endAt=0.21, beginAt= 0, speed = 3, fadeLength = 0.2 },                
