...
public class LuaGameWrap
{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DebugMode(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			bool o = LuaGame.DebugMode();
	...
	static int LoadAssetAtPath(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			UnityEngine.Object o = LuaGame.LoadAssetAtPath(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int TestProtobuf(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			ByteBuffer arg0 = (ByteBuffer)ToLua.CheckObject<ByteBuffer>(L, 1);
			LuaGame.TestProtobuf(arg0);
			return 0;
		}
		catch (Exception e)
		{
