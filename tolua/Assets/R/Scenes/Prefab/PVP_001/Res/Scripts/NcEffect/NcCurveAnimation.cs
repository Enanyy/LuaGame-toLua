...
// 	}
    ...
    void BackupOriginalValue()
    {
		orgDelayTime = m_fDelayTime;
        foreach (NcInfoCurve curveInfo in m_CurveInfoList)
        {
            if (curveInfo.m_bEnabled == false)
                continue;
                ...
                case NcInfoCurve.APPLY_TYPE.COLOR:
                    {
						...
						} else*/
                        {
                            ...
                            if (GetComponent<Renderer>() != null)
                            {
                                ...
                                if (m_ColorName != null)
                                {
                                    orgColor = GetComponent<Renderer>().sharedMaterial.GetColor(m_ColorName);
                                }
                            }
                        }
                        break;
                ...
                case NcInfoCurve.APPLY_TYPE.COLOR:
                    {
						...
						} else*/
                        {
                            ...
                            if (GetComponent<Renderer>() != null)
                            {
                                ...
                                if (m_ColorName != null)
                                {                                    
                                    GetComponent<Renderer>().sharedMaterial.SetColor(m_ColorName, orgColor);
                                }
                            }
                        }
                        break;
